            ...
            <ul className="grid gap-3 p-5 grid-cols-[.75fr_1fr] h-[316px] font-cabinet w-[600px]">
              <li className="row-span-3">
                ...
                <NavigationMenuLink asChild className="mt-2">
                  <Link
                    className="block select-none rounded-md p-3 text-center leading-none no-underline outline-none transition-colors bg-blue-100/50 hover:bg-blue-300 focus:bg-slate-900 focus:text-white"
                    to="/main-projects"
                  >
                ...
                <NavigationMenuLink asChild className="mt-2">
                  <Link
                    className="block select-none text-center rounded-md p-3 leading-none no-underline outline-none transition-colors bg-blue-100/50 hover:bg-blue-300 focus:bg-slate-900 focus:text-white"
                    to="/mini-projects"
                  >
                ...
                <NavigationMenuLink asChild className="mt-2">
                  <Link
                    className="cursor-not-allowed block select-none text-center rounded-md p-3 leading-none no-underline outline-none transition-colors bg-blue-100/50 hover:bg-blue-300 focus:bg-slate-900 focus:text-white"
                    to="/active-projects"
                  >
          ...
          <NavigationMenuContent>
            <ul className="grid gap-3 p-5 grid-cols-[.75fr_1fr] font-cabinet w-[600px]">
              <li className="row-span-3">
                ...
                <NavigationMenuLink asChild className="mt-2">
                  <a
                    className=" select-none flex items-center justify-center rounded-md p-3 text-center leading-none no-underline outline-none transition-colors bg-green-200/50 hover:bg-green-400 focus:bg-slate-900 focus:text-white"
                ...
                <NavigationMenuLink asChild className="mt-2">
                  <a
                    className=" select-none flex items-center justify-center text-center rounded-md p-3 leading-none no-underline outline-none transition-colors bg-blue-200/50 hover:bg-blue-400 focus:bg-slate-900 focus:text-white"
                ...
                <NavigationMenuLink asChild className="mt-2">
                  <a
                    className="flex items-center justify-center select-none text-center rounded-md p-3 leading-none no-underline outline-none transition-colors bg-orange-200/50 hover:bg-orange-300 focus:bg-slate-900 focus:text-white"
